#ifndef QUERYHOLDER_H_
#define QUERYHOLDER_H_

#include "SQLOperation.h"

#include <vector>

class POOL_DATABASE_API SQLQueryHolderBase
{
...
class POOL_DATABASE_API SQLQueryHolderTask : public SQLOperation
{
public:
...
class POOL_DATABASE_API SQLQueryHolderCallback
{
public:
